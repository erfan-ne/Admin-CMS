  ...
  modalScreen.insertAdjacentHTML(
    ...
    <div class="modal">
      ...
      <header class="modal-header">
        <h3>حذف دوره</h3>
        <button class="close-modal" onclick="hideRemoveCourseModal()">
      ...
      <footer class="modal-footer">
        <button class="cancel" onclick="hideRemoveCourseModal()">انصراف</button>
...
const hideRemoveCourseModal = () => modalScreen.classList.add("hidden")
